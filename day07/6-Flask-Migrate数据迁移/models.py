...
class Student(db.Model):
    __tablename__ = 'tb_migrate_1vn_student'
...
class StudentAddress(db.Model):
    __tablename__ = 'tb_migrate_1vn_student_info'
    ...
    address = db.Column(db.String(500), comment="收货详细地址")
    mobile = db.Column(db.String(15), comment="收货人电话")

    stu_id = db.Column(db.Integer, db.ForeignKey('tb_migrate_1vn_student.id'), comment='student外键')
